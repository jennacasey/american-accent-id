...
############## ADJUST THESE ####################
epochs = 60 # probably make big - small dataset, cautious of overfitting
learning_rate = 0.00001 # just have to experiment - if loss decreasing slowly, increase learning rate
weight_decay = 0.001 # prevents overfitting - if training loss goes to 0, but dev set is bad, increase weight decay

################ PROBABlY GOOD ####################
dim = 64 # probably plenty, but make bigger if not learning
